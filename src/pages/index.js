        ...
        <div className="row py-lg-5">
          <div className="col-sm-8  mx-auto">
            ...
            <p className="justify">
              ...
              I am part of the <a href="http://www.perseo.eu/" target="_blank" rel="noreferrer">perseo</a> project, a Marie Skłodowska-Curie European Training Network (ETN) funded by the European Commission that allows me to collaborate with the top european researchers in the field.
